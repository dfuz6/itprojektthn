...
<div class="text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-center" style="margin-top: 40px;">
					...
					<h2 class="text-center">Zahlensysteme: Theoritische Frage</h2>
      ...
      <div class="table-responsive">
		<table class="table table-bordered">
			...
			<tbody id="numberSystemQuestionTable">
...
<script>
	...
	function callQuestions(){
		db.createIndex({
			...
			db.find({
			selector: {category: 'Zahlensysteme', type:'question'},
			fields: ['_id', 'question', 'difficulty']
		    }).then(function (result) {
			var questionList = result.docs;
			var table = document.getElementById("numberSystemQuestionTable");
			for(var i = 0; i < questionList.length; i++){
				...
				actionCol.innerHTML = '<a href="?module=numbersystem&smodule=question&id='+questionList[i]._id+'" class="btn btn-info">Go!</a>';
