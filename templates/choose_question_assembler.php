...
<div class="text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-center" style="margin-top: 40px;">
					...
					<h2 class="text-center">Assembler</h2>
      ...
      <div class="table-responsive">
		<table class="table table-bordered">
			...
			<tbody id="assemblerQuestionTable">
...
<script>
	...
	function callQuestions(){
		db.createIndex({
			...
			db.find({
			selector: {category: 'Assembler', type:'question'},
			fields: ['_id', 'question', 'difficulty']
		    }).then(function (result) {
			var questionList = result.docs;
			var table = document.getElementById("assemblerQuestionTable");
			for(var i = 0; i < questionList.length; i++){
				...
				actionCol.innerHTML = '<a href="?module=assembler&id='+questionList[i]._id+'" class="btn btn-info">Go!</a>';
